...
loadxrdb()
{
	...
	if (display != NULL) {
		...
		if (resm != NULL) {
			...
			if (xrdb != NULL) {
				XRDB_LOAD_COLOR("dwm.color6", normfgcolor); // []= 0B 0B | vol:
				XRDB_LOAD_COLOR("dwm.color0", normbgcolor); // bg of the above
				
				XRDB_LOAD_COLOR("dwm.color0", titleselfgcolor); // tititle 
				XRDB_LOAD_COLOR("dwm.color12", titleselbgcolor); // tittle 
				
				XRDB_LOAD_COLOR("dwm.color6", tagsnormfgcolor); // 2 > 9
				XRDB_LOAD_COLOR("dwm.color0", tagsnormbgcolor); // 2 > 9
			
				XRDB_LOAD_COLOR("dwm.color0", tagsselfgcolor); // tag 1
				XRDB_LOAD_COLOR("dwm.color12", tagsselbgcolor); // tag 1

				XRDB_LOAD_COLOR("dwm.color0", titlenormfgcolor); // tittle without tittle.
				XRDB_LOAD_COLOR("dwm.color0", titlenormbgcolor); // tittle wihtout tittle.
										 
				XRDB_LOAD_COLOR("dwm.color14", selbordercolor); // border color 
				XRDB_LOAD_COLOR("dwm.color14", selfloatcolor); 	// Resized mouse Color (float)
				XRDB_LOAD_COLOR("dwm.color0", normfloatcolor);  // Resized mouse Color (float)
									       
//				XRDB_LOAD_COLOR("dwm.color0", selfgcolor);
//				XRDB_LOAD_COLOR("dwm.color14", selbgcolor);
      			
				
				XRDB_LOAD_COLOR("dwm.color0", normbordercolor); // border of unsel window

//				XRDB_LOAD_COLOR("dwm.color8", titlenormbordercolor);
//				XRDB_LOAD_COLOR("dwm.color8", titlenormfloatcolor);
...
//				XRDB_LOAD_COLOR("dwm.color8", tagsnormfloatcolor);

//				XRDB_LOAD_COLOR("dwm.color8", tagsselbordercolor);
//				XRDB_LOAD_COLOR("dwm.color8", tagsselfloatcolor);

//				XRDB_LOAD_COLOR("dwm.color8", hidnormfgcolor);
//				XRDB_LOAD_COLOR("dwm.color8", hidnormbgcolor);

//				XRDB_LOAD_COLOR("dwm.color8", hidselfgcolor);
//				XRDB_LOAD_COLOR("dwm.color8", hidselbgcolor);

//				XRDB_LOAD_COLOR("dwm.color8", urgfgcolor);
//				XRDB_LOAD_COLOR("dwm.color8", urgbgcolor);

//				XRDB_LOAD_COLOR("dwm.color8", urgbordercolor);
//				XRDB_LOAD_COLOR("dwm.color8", urgfloatcolor);
				#if RENAMED_SCRATCHPADS_PA7CH
